...
const BottomNavbar: React.FC = () => {
  ...
  return (
    <footer
      className={` shadow-[0_-4px_20px_rgba(255,255,255,0.2)]  rounded-tl-lg z-100 flex flex-col rounded-tr-lg bg-black shadow  w-screen transition transition-all ease-out duration-500 ${isDrawerOpen ? `justify-between pb-8 h-screen-minus-nav` : 'h-16 justify-center'}`}
    >
      {isDrawerOpen && (
        <CategoriesDrawer
