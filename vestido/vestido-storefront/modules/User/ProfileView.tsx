...
//   return (
//     <>
//       <div className="2xl:px-72 my-20 text-white">
...
//         >
//           <div className="w-full md:w-64 md:basis-1/4 p-4">
//             <TabsList className="flex flex-col bg-transparent justify-start items-start text-white text-sm md:text-base">
//               <TabsTrigger
//                 className="hidden md:block bg-transparent data-[state=active]:border-none  data-[state=active]:bg-transparent text-lg data-[state=active]:text-[#48cab2] my-4 px-0"
//                 value="overview"
//               >
//                 Overview
//               </TabsTrigger>
//               <div>ORDERS</div>
//               <TabsTrigger
//                 className="bg-transparent border-none data-[state=active]:border-none data-[state=active]:text-[#48cab2] data-[state=active]:bg-transparent text-lg data-[state=active]:text-[#48cab2] my-4 px-0"
//                 value="orders"
//               >
//                 Orders & Returns
//               </TabsTrigger>
//               <div>ACCOUNT</div>
//               <TabsTrigger
//                 className="bg-transparent border-none data-[state=active]:border-none data-[state=active]:text-[#48cab2] data-[state=active]:bg-transparent text-lg data-[state=active]:text-[#48cab2] mt-4 mb-1 px-0"
//                 value="profile"
//               >
//                 Profile
//               </TabsTrigger>
//               <TabsTrigger
//                 className="bg-transparent border-none data-[state=active]:border-none data-[state=active]:text-[#48cab2] data-[state=active]:bg-transparent text-lg data-[state=active]:text-[#48cab2] my-1 px-0"
//                 value="addresses"
//               >
//                 Addresses
//               </TabsTrigger>
...
//             </TabsList>
//           </div>
//           <div className="hidden md:block md:basis-4/5 px-4">
          ...
          {!isSmallScreen || !selectedNav ? (
            <div className="w-full md:w-64 md:basis-1/4 p-2 md:p-4">
              <TabsList className="flex flex-col bg-transparent justify-start items-start text-white text-sm md:text-base">
                ...
                <div className="text-xs md:text-base">ORDERS</div>
                <TabsTrigger
                  className="bg-transparent border-none data-[state=active]:border-none data-[state=active]:text-[#48cab2] data-[state=active]:bg-transparent text-sm md:text-lg data-[state=active]:text-[#48cab2] my-4 px-0"
                  value="orders"
                >
                  Orders & Returns
                </TabsTrigger>
                <div className="text-xs md:text-base">ACCOUNT</div>
                <TabsTrigger
                ...
                <div className="text-xs md:text-base">LEGAL</div>
                <ul>
                  <li className="my-4">
                    <Link
                      href="/terms-and-conditions"
