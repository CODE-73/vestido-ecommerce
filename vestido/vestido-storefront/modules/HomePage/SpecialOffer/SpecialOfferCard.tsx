...
const SpecialOfferCard: React.FC<SpecialOfferCardProps> = ({ data }) => {
  ...
  return (
    ...
    <div className={`flex flex-col items-center group relative mb-10 `}>
      ...
      <div className="hidden group-hover:flex flex-col gap-3 absolute top-3 right-3">
        {' '}
       <AddToWishListButton/>
      <AddToCompareButton/>
      <QuickViewButton/>
      </div>
      <div className=" absolute bottom-36 bg-white opacity-80 font-extralight text-[#333333] text-lg text-center px-16">
